...
function Player() {
  ...
  return courseData? (
    <>
    <div className='p-4 sm:p-10 flex flex-col-reverse md:grid md:grid-cols-2 gap-10 md:mx-36'>
      {/* left col */}
      ...
      <div className='md:mt-10'>
        {playerData?
        <div>
          <YouTube videoId={playerData.lectureUrl.split('/').pop().split('=')[1]}  iframeClassName='w-full aspect-video'/>
          {console.log(playerData.lectureUrl.split('/').pop().split('=')[1])}
