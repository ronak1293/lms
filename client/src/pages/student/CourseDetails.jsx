...
//purchase course
 ...
 bg-gradient-to-b from-cyan-100/70"
        ...
        <div className="max-w-xl z-10 text-gray-500">
          <h1 className="md:tex-3xl  text-2xl font-semibold text-gray-800">
          ...
          ></p>
           ...
           <div className="flex items-center space-x-2 z-1 pt-3 pb-1 text-sm">
        ...
        <p className="text-sm">Course by <span className="text-blue-600 underline">Ronak rewar</span></p>
        ...
        <div className="max-w-[424px] z-10 shadow-custom-card rounded-t md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]">
          ...
          <div className="p-5">
            <div className="flex items-center gap-2">
              <img className="w-3.5" src={assets.time_left_clock_icon} alt="time left clok icon" />
            ...
            <div className="flex items-center text-sm md:text-default gap-4 pt-2 md:pt-4 text-gray-500">
              ...
              <div className="flex items-center gap-1">
                ...
                <p className="text-center">{calculateNoOfLectures(courseData)} lessons</p>
              </div>
              </div>

              
            </div>
            <button onClick={enrollCourse} className="md:mt-6 mt-9 w-full py-3 rounded bg-blue-600 text-white font-medium">{isAlreadyEnrolled?'Already Enrolled':'Enroll now'}</button>
